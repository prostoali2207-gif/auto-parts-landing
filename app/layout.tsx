...
import "./ui-v7-hero-3d-progressive.css";
...
export const metadata: Metadata = {
  ...
  title: "Das Motors — автозапчасти из ОАЭ в Россию и СНГ",
  ...
  openGraph: { type: "website", url: "/", title: "Das Motors — автозапчасти из ОАЭ в Россию и СНГ", description: "Запросите автозапчасть из ОАЭ для отправки в Россию и страны СНГ по VIN, данным автомобиля, фото или OEM / Part Number.", siteName: "Das Motors", locale: "ru_AE" },
  twitter: { card: "summary", title: "Das Motors — автозапчасти из ОАЭ в Россию и СНГ", description: "Запросите автозапчасть из ОАЭ для отправки в Россию и страны СНГ по VIN, данным автомобиля, фото или OEM / Part Number." },
};
